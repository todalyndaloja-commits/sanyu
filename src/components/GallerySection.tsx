          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center group">
              <div className="relative overflow-hidden rounded-2xl mb-4 aspect-square">
                <img 
                  src="/lovable-uploads/3d9cebf4-c39e-4e54-860f-def9a7c0961d.png" 
                  alt="Juliana - Equipe Sanyu Brasil"
              ...
              <p className="text-sm text-muted-foreground">Especialista em Importação</p>
            </div>

            <div className="text-center group">
              <div className="relative overflow-hidden rounded-2xl mb-4 aspect-square">
                <img 
                  src="/lovable-uploads/52d7095c-c3a0-4f89-9548-606c0f86af96.png" 
                  alt="Vitória - Equipe Sanyu Brasil"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-sanyu-blue/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </div>
              <h4 className="font-semibold text-lg">Vitória</h4>
              <p className="text-sm text-muted-foreground">Consultora Comercial</p>
            </div>

            <div className="text-center group">
              <div className="relative overflow-hidden rounded-2xl mb-4 aspect-square">
                <img 
                  src="/lovable-uploads/0aa761fe-7305-4a6e-8af3-27335df5e070.png" 
                  alt="Allan - Equipe Sanyu Brasil"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-sanyu-blue/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </div>
              <h4 className="font-semibold text-lg">Allan</h4>
              <p className="text-sm text-muted-foreground">Analista de Produtos</p>
            </div>

            <div className="text-center group">
              <div className="relative overflow-hidden rounded-2xl mb-4 aspect-square">
                <img 
                  src="/lovable-uploads/760b5d3d-f3c5-40a2-8c1c-cc79a865db24.png" 
                  alt="David - Equipe Sanyu Brasil"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-sanyu-blue/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </div>
              <h4 className="font-semibold text-lg">David</h4>
