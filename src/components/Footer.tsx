          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 w-full">
              ...
              <div className="flex items-center gap-4">
                ...
                <a href="https://wa.me/5511919532904" target="_blank" rel="noopener noreferrer" className="bg-green-500 p-2 rounded-full hover:bg-green-600 transition-colors" aria-label="WhatsApp">
